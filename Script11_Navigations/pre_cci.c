# 1 "c:\\pvs\\pvs461_fdafix\\script11_navigations\\\\combined_Script11_Navigations.c"
...
# 1 "c:\\pvs\\pvs461_fdafix\\script11_navigations\\\\combined_Script11_Navigations.c" 2
...
# 2 "c:\\pvs\\pvs461_fdafix\\script11_navigations\\\\combined_Script11_Navigations.c" 2
...
# 3 "c:\\pvs\\pvs461_fdafix\\script11_navigations\\\\combined_Script11_Navigations.c" 2
...
# 4 "c:\\pvs\\pvs461_fdafix\\script11_navigations\\\\combined_Script11_Navigations.c" 2
...
Action()
{
	...
	lr_end_transaction("01_OpenApplication", 2);
...
# 564 "Action.c"
	...
	lr_end_transaction("03_TriggeredAlertsEVDASReview",2);
...
# 700 "Action.c"
	lr_end_transaction("04_TriggeredAlertsAdhocReview",2);
...
# 791 "Action.c"
	...
	lr_end_transaction("05_TriggeredAlertsLiteratureReview",2);
	...
	lr_end_transaction("06_FilterOnArticleId",2);
	...
	lr_end_transaction("07_RemoveFilter",2);
	...
	lr_end_transaction("08_SortOnAuthor",2);
	...
	lr_end_transaction("09_CheckAbstractView",2);
	...
	lr_end_transaction("11_AlertConfiguration-View Alerts",2);
	...
	lr_end_transaction("12_AlertConfiguration-View Execution Status",2);
	...
	lr_end_transaction("13_AlertConfiguration-View Execution Status Completed",2);
	...
	lr_end_transaction("11_Logout",2);

	lr_think_time(3);

	return 0;
}
# 5 "c:\\pvs\\pvs461_fdafix\\script11_navigations\\\\combined_Script11_Navigations.c" 2
...
# 6 "c:\\pvs\\pvs461_fdafix\\script11_navigations\\\\combined_Script11_Navigations.c" 2
