Action()
{
	...
	web_custom_request("issuetoken", 
		...
		"919648714761-55j965o0km033psv3i9qls5mo3qtdrb0.apps.googleusercontent.com&origin=pkedcjkdefgpdelpbcmbmeomcjbeemfm&device_id=1b74ddb6-2c95-4748-9b77-0651996dadaf&device_type=chrome&lib_ver=extension", 
		LAST);
	...
	web_custom_request("command", 
		...
		"BodyBinary=\n\\x14bhagya.n.r@gmail.com\\x104\\x18\\x02*8\\x12\\x04\\x08\\x00\\x10\\x00\\x18\\x012\\x04\\x08\\xDE\\xD8\\x122!\\x08\\x81\\xF5\\x02\\x12\\x1B \\x00H\\xA7\\xF1\\xF9\\x9A\\x81.p\\xA7\\xF1\\xF9\\x9A\\x81.\\x88\\x01\\xBB\\xDC\\x88\\xC6\\x95\\x93\\xA0\\xB4\\x01@\\x00H\\x07\\xC0>\\x01:%z00000147-73aa-5583-0000-000053d3e1e0R\\x16\n\\x02\\x08\n\n\\x02\\x08\t\n\\x02\\x08\\x07\n\\x02\\x08\\x05\\x10\\x01\\x18\\x00 \\x00Z\\x80\\x01\n~\\x12|Chrome WIN 79.0.3945.130 "
	...
	web_url("threatListUpdates_fetch", 
		...
		"Ch0KDGdvb2dsZWNocm9tZRINNzkuMC4zOTQ1LjEzMBopCAUQARobCg0IBRAGGAEiAzAwMTABEOz_BxoCGAjJu_L1IgQgASACKAEaKQgBEAEaGwoNCAEQBhgBIgMwMDEwARDK_"
		"_IgQgASACKAEaKAgQEAEaGgoNCBAQBhgBIgMwMDEwARCsARoCGAjkF44SIgQgASACKAEiAggB&$ct=application/x-protobuf&key=AIzaSyBOti4mM-6x9WDnZIjIeyEU21OpBXqWBgw", 
		"Resource=1", 
	...
	web_custom_request("", 
		...
		"BodyBinary=\nY\n\\x06\n\\x04\\x08\\x03\\x10\\x02\\x12%\n\\x06\n\\x04\\x08\\x03\\x10\\x01\\x12\\x12\tr\\xEA\\xA5F\t\\x8B\\xC7\\xBB\\x11\\xEDD\\x05\\xA5M\\xF2\\xF0\\xB5\\x1A\\x07\\x08\\x86\\x18\\x10\\x03\\x18\\x01\\x1A\\x18\\x08\\x00\\x12\\x14\\xDA9\\xA3\\xEE^kK\r2U\\xBF\\xEF\\x95`\\x18\\x90\\xAF\\xD8\\x07\t \\x85\\xD1\\xDD\\xA1\\xF4\\x80\\x03(\\x002\\x0118\\x9F\\x082\\x95\\x01\n\\x90\\x01\n\\x07\\x08\\x03\\x10\\xAC\\xA1\\xCD\t\\x12sMozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML"
	...
	web_add_cookie("dtPC=1$475281097_917h-vIEIFREPMPIBFAGDVJLJOMIFMEFGLANVA; DOMAIN=10.100.22.24");

	web_add_cookie("rxvt=1580877099927|1580875285705; DOMAIN=10.100.22.24");

	web_add_cookie("dtSa=true%7CC%7C-1%7CLog%20in%7C-%7C1580875309016%7C475281097_917%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2Flogin%2Fauth%7CLogin%7C1580875289743%7C%7C; DOMAIN=10.100.22.24");
	...
	web_submit_data("authenticate", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=_csrf", "Value=abc0318d-7e58-43ee-8785-ccc05e0f7c8b", ENDITEM, 
		"Name=username", "Value=bhagya", ENDITEM, 
		"Name=password", "Value=bhagya", ENDITEM, 
		LAST);

	web_add_cookie("dtPC=1$475310520_160h1vIEIFREPMPIBFAGDVJLJOMIFMEFGLANVA; DOMAIN=10.100.22.24");

	web_add_cookie("rxvt=1580877110533|1580875285705; DOMAIN=10.100.22.24");
	...
	web_url("aggAlertByStatus", 
		"URL=http://10.100.22.24:8181/signal/dashboard/aggAlertByStatus?_=1580875311764", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t278.inf", 
	...
	web_url("ahaByStatus", 
		"URL=http://10.100.22.24:8181/signal/dashboard/ahaByStatus?_=1580875311765", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t279.inf", 
	...
	web_url("getProductByStatus", 
		"URL=http://10.100.22.24:8181/signal/dashboard/getProductByStatus?type=Aggregate%20Case%20Alert&_=1580875311768", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t280.inf", 
	...
	web_add_header("X-CSRF-TOKEN", 
		"abc0318d-7e58-43ee-8785-ccc05e0f7c8b");
	...
	web_url("7052", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875311769", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t282.inf", 
	...
	web_websocket_connect("ID=0", 
		"URI=ws://10.100.22.24:8181/signal/stomp/257/3p0vfms0/websocket", 
	...
	web_url("signalList", 
		"URL=http://10.100.22.24:8181/signal/dashboard/signalList?_=1580875311771", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t285.inf", 
	...
	web_url("actionList", 
		"URL=http://10.100.22.24:8181/signal/dashboard/actionList?_=1580875311772", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t286.inf", 
	...
	web_add_cookie("rxvt=1580877119548|1580875285705; DOMAIN=10.100.22.24");
	...
	web_url("getProductByStatus_2", 
		"URL=http://10.100.22.24:8181/signal/dashboard/getProductByStatus?type=Single%20Case%20Alert&_=1580875311767", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t289.inf", 
	...
	web_url("sideBar", 
		"URL=http://10.100.22.24:8181/signal/dashboard/sideBar?_=1580875311762", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t292.inf", 
	...
	web_url("caseByStatus", 
		"URL=http://10.100.22.24:8181/signal/dashboard/caseByStatus?_=1580875311763", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t293.inf", 
	...
	web_add_cookie("rxvt=1580877122284|1580875285705; DOMAIN=10.100.22.24");
	...
	web_url("alertByDueDate", 
		"URL=http://10.100.22.24:8181/signal/dashboard/alertByDueDate?_=1580875311766", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t295.inf", 
	...
	web_url("alertList", 
		"URL=http://10.100.22.24:8181/signal/dashboard/alertList?_=1580875311770", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t296.inf", 
	...
	web_add_cookie("dtPC=1$475310520_160h-vIEIFREPMPIBFAGDVJLJOMIFMEFGLANVA; DOMAIN=10.100.22.24");

	web_add_cookie("rxvt=1580877130032|1580875285705; DOMAIN=10.100.22.24");

	web_add_auto_header("Accept", 
		"*/*");

	web_url("7052_2", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875311773", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t297.inf", 
	...
	web_url("7052_3", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875311774", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/", 
		"Snapshot=t299.inf", 
	...
	web_add_cookie("dtSa=true%7CC%7C-1%7CQualitative%20Review%7C-%7C1580875393683%7C475310520_160%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2F%7CDashboard%7C1580875325968%7C%7C; DOMAIN=10.100.22.24");
	...
	web_add_cookie("dtPC=1$475395122_179h1vIEIFREPMPIBFAGDVJLJOMIFMEFGLANVA; DOMAIN=10.100.22.24");

	web_add_cookie("dtLatC=9; DOMAIN=10.100.22.24");

	web_add_cookie("rxvt=1580877195157|1580875285705; DOMAIN=10.100.22.24");
	...
	web_url("7052_4", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875395237", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/review", 
		"Snapshot=t305.inf", 
	...
	web_websocket_connect("ID=1", 
		"URI=ws://10.100.22.24:8181/signal/stomp/964/8eu3yhmo/websocket", 
		"Origin=http://10.100.22.24:8181", 
		"OnOpenCB=OnOpenCB1", 
	...
	web_url("listConfig", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=9&order%5B0%5D%5Bdir%5D=desc&start=0&length=25&search%5Bvalue%5D=&search%5Bregex%5D=false&_=1580875395236", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/review", 
		"Snapshot=t307.inf", 
	...
	web_add_cookie("dtPC=1$475395122_179h-vIEIFREPMPIBFAGDVJLJOMIFMEFGLANVA; DOMAIN=10.100.22.24");

	web_add_cookie("rxvt=1580877202755|1580875285705; DOMAIN=10.100.22.24");

	web_add_auto_header("Accept", 
		"*/*");

	web_url("7052_5", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875395238", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/review", 
		"Snapshot=t308.inf", 
	...
	web_url("7052_6", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875395239", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/review", 
		"Snapshot=t309.inf", 
	...
	web_url("details", 
		"URL=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/review", 
		"Snapshot=t310.inf", 
	...
	web_url("viewColumnInfo", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495", 
		"Snapshot=t311.inf", 
		"Mode=HTTP", 
		LAST);
	...
	web_url("7052_7", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875437920", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495", 
		"Snapshot=t313.inf", 
	...
	web_submit_data("495", 
		"Action=http://10.100.22.24:8181/signal/singleCaseAlert/listByExecutedConfig/495?cumulative=false&adhocRun=false&dashboardFilter=&tagName=&isFilterRequest=false&filters=[]", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495", 
		"Snapshot=t315.inf", 
	...
	web_url("7052_8", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875437921", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495", 
		"Snapshot=t319.inf", 
	...
	web_url("7052_9", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875437922", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495", 
		"Snapshot=t320.inf", 
	...
	web_add_cookie("dtSa=true%7CC%7C-1%7CDetailed%20View%7C-%7C1580875471857%7C475437841_302%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2FsingleCaseAlert%2Fdetails%3FcallingScreen%3Dreview%26configId%3D495%7CQualitative%20Alert%20Details%7C1580875443424%7C%7C; DOMAIN=10.100.22.24");
	...
	web_url("details_2", 
		"URL=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=true", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495", 
		"Snapshot=t322.inf", 
	...
	web_url("viewColumnInfo_2", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=true", 
		"Snapshot=t323.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("7052_10", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875473885", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=true", 
		"Snapshot=t324.inf", 
	...
	web_url("7052_11", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875473886", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=true", 
		"Snapshot=t329.inf", 
	...
	web_url("7052_12", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875473887", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=true", 
		"Snapshot=t330.inf", 
	...
	web_add_cookie("dtSa=true%7CC%7C-1%7CDetailed%20View%7C-%7C1580875502871%7C475473807_489%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2FsingleCaseAlert%2Fdetails%3FcallingScreen%3Dreview%26configId%3D495%26viewId%3D6199%26isCaseDetailView%3Dtrue%7CQualitative%20Alert%20Details%7C1580875477094%7C%7C; DOMAIN=10.100.22.24");
	...
	web_url("details_3", 
		"URL=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=true", 
		"Snapshot=t332.inf", 
	...
	web_url("viewColumnInfo_3", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t333.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("7052_13", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875505017", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t334.inf", 
	...
	web_url("7052_14", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875505018", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t338.inf", 
	...
	web_custom_request("json", 
		"URL=https://update.googleapis.com/service/update2/json?cup2key=9:2347642396&cup2hreq=e112900dcc33561f405829a706123951de02e28508d567dadbb40c88d44fd0ba", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=", 
		...
		"Body={\"request\":{\"@os\":\"win\",\"@updater\":\"chrome\",\"acceptformat\":\"crx2,crx3\",\"app\":[{\"appid\":\"ihnlcenocehgdaegdmhbidjhnhdchfmm\",\"brand\":\"CHBD\",\"enabled\":true,\"ping\":{\"ping_freshness\":\"{04b3b39a-2533-415d-b78b-089421042f31}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"0.0.0.0\"},{\"appid\":\"oimompecagnajdejgnnjijobebaeigek\",\"brand\":\"CHBD\",\"enabled\":true,\"ping\":{\"ping_freshness\":\"{1377cd61-d054-41b8-baad-a2e9aa807d16}\",\"rd\":4782},\"updatecheck\":{},\""
		"version\":\"4.10.1610.0\"},{\"appid\":\"mimojjlkmoijpicakmndhoigimigcmbb\",\"brand\":\"CHBD\",\"cohort\":\"1:d0j:\",\"cohorthint\":\"Chrome [M50+]\",\"cohortname\":\"Chrome [M50+]\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.4b78391059704408ee3f5c7dcc13ab02384be6f62656c1b727d267faa1317713\"}]},\"ping\":{\"ping_freshness\":\"{60ddab19-112f-4632-91d1-7585d5de2041}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"32.0.0.321\"},{\"appid\":\"gcmjkmgdlgnkkcocmoeiminaijmmjnii\",\"brand\":\""
		"CHBD\",\"cohort\":\"1:bm1:uir@0.01\",\"cohorthint\":\"M54ToM99\",\"cohortname\":\"M54ToM99\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.64c0ff22c119d7881f617de7f2fc4111b6fbd86410d455c0b7e9bb5975918b7b\"}]},\"ping\":{\"ping_freshness\":\"{3358ab50-9aae-476b-87fc-b9b6fd871a73}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"9.9.0\"},{\"appid\":\"llkgjffcdpffmhiakmfcdcblohccpfmo\",\"brand\":\"CHBD\",\"enabled\":true,\"ping\":{\"ping_freshness\":\"{5fe5dfed-dda2-4b62-934e-095ee316418e}\","
		"\"rd\":4782},\"updatecheck\":{},\"version\":\"0.0.0.0\"},{\"appid\":\"hnimpnehoodheedghdeeijklkeaacbdc\",\"brand\":\"CHBD\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.6f6bc93dcd62dc251850d2ff458fda96083ceb7fbe8eeb11248b8485ef2aea23\"}]},\"ping\":{\"ping_freshness\":\"{ab080937-2620-4622-ba36-73c2571bbf9e}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"0.57.44.2492\"},{\"appid\":\"aemomkdncapdnfajjbbcbdebjljbpmpj\",\"brand\":\"CHBD\",\"enabled\":true,\"ping\":{\"ping_freshness\":\""
		"{ecef6d9a-5fa6-4021-be8f-9986c678cec3}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"1.0.5.0\"},{\"appid\":\"khaoiebndkojlmppeemjhbpbandiljpe\",\"brand\":\"CHBD\",\"cohort\":\"1:cux:\",\"cohorthint\":\"Auto\",\"cohortname\":\"Auto\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.5cb8df53fe2b86bf838ea2c9ffc3d5ef8460f679a779ac8aa924b5afffd052cb\"}]},\"ping\":{\"ping_freshness\":\"{a936cec6-795b-47f2-93fc-b16e4958758e}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"42\"},{\"appid\":\""
		"giekcmmlnklenlaomppkphknjmnnpneh\",\"brand\":\"CHBD\",\"cohort\":\"1:j5l:\",\"cohorthint\":\"Auto\",\"cohortname\":\"Auto\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.3eb16d6c28b502ac4cfee8f4a148df05f4d93229fa36a71db8b08d06329ff18a\"}]},\"ping\":{\"ping_freshness\":\"{39b26735-4d8b-4893-ae05-9ece27a18ebe}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"7\"},{\"appid\":\"hfnkpimlhhgieaddgfemjhofmfblmnib\",\"brand\":\"CHBD\",\"cohort\":\"1:jcl:\",\"cohorthint\":\"Auto\",\"cohortname\":"
		"\"Auto\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.3bf2d3b81ffffe8ccf9bd01cffa699d1a592aa060f68d424951a6fb4aa9c4b11\"}]},\"ping\":{\"ping_freshness\":\"{1f5d9796-66d0-4acb-93e8-a91aa07d26ad}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"5677\"},{\"appid\":\"bklopemakmnopmghhmccadeonafabnal\",\"brand\":\"CHBD\",\"cohort\":\"1:swl:\",\"cohorthint\":\"Auto\",\"cohortname\":\"Auto\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\""
		"1.bca9d2c2a453524714c034c874bf787c2f5c68b8d5c6233a18ba8e14c402091d\"}]},\"ping\":{\"ping_freshness\":\"{c141ed27-6571-4974-9647-a68cada9fad0}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"2\"},{\"appid\":\"ehgidpndbllacpjalkiimkbadgjfnnmc\",\"brand\":\"CHBD\",\"cohort\":\"1:ofl:\",\"cohorthint\":\"stable64\",\"cohortname\":\"stable64\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.a8a79d350c2a5e3bc36226633a8e0bed0dfab184e77f38fc8f0820ebacf8eafc\"}]},\"ping\":{\"ping_freshness\":\""
		"{9b23d1d1-63b1-4b56-afca-2c9891a8cf3d}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"2018.8.8.0\"},{\"appid\":\"jflookgnkcckhobaglndicnbbgbonegd\",\"brand\":\"CHBD\",\"cohort\":\"1:s7x:\",\"cohorthint\":\"Auto\",\"cohortname\":\"Auto\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.745cd87cb4ac32d099a7c4bfd52f6eedaeef42a387051590de46a1ad1d1437d4\"}]},\"ping\":{\"ping_freshness\":\"{6ad59ac4-cae8-4ba3-aef9-69be730c8803}\",\"rd\":4782},\"updatecheck\":{},\"version\":\"69\"},{\"appid\":\""
		"gkmgaooipdjhmangpemjhigmamcehddo\",\"brand\":\"CHBD\",\"cohort\":\"1:pw3:\",\"cohorthint\":\"Stable\",\"cohortname\":\"Stable\",\"enabled\":true,\"packages\":{\"package\":[{\"fp\":\"1.f298eb5adfbd0b201a6afd399da93bb3f1516e7c13f046fb94b221e9120081ee\"}]},\"ping\":{\"ping_freshness\":\"{643dbbf9-2aca-4d55-9b3a-412670bdd9d2}\",\"rd\":4782},\"tag\":\"eset_exp_b\",\"updatecheck\":{},\"version\":\"79.228.200\"}],\"arch\":\"x64\",\"dedup\":\"cr\",\"domainjoined\":false,\"hw\":{\"physmemory\":16},\"lang\""
		":\"en-US\",\"nacl_arch\":\"x86-64\",\"os\":{\"arch\":\"x86_64\",\"platform\":\"Windows\",\"version\":\"10.0.17763.973\"},\"prodversion\":\"79.0.3945.130\",\"protocol\":\"3.1\",\"requestid\":\"{96e0a350-fa75-4b91-8327-88031bd7387c}\",\"sessionid\":\"{a0e3e568-1654-4e99-9b7b-c87967e399ca}\",\"updater\":{\"autoupdatecheckenabled\":true,\"ismachine\":true,\"lastchecked\":0,\"laststarted\":0,\"name\":\"Omaha\",\"updatepolicy\":-1,\"version\":\"1.3.35.442\"},\"updaterversion\":\"79.0.3945.130\"}}", 
		LAST);
	...
	web_url("fetchPossibleValues", 
		"URL=http://10.100.22.24:8181/signal/singleCaseAlert/fetchPossibleValues?executedConfigId=495", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t346.inf", 
	...
	web_url("7052_15", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875505019", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t347.inf", 
	...
	web_url("7052_16", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875505020", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t348.inf", 
	...
	web_submit_data("495_4", 
		...
		"Name=sort", "Value=selected", ENDITEM, 
		"Name=direction", "Value=asc", ENDITEM, 
		"Name=advancedFilterId", "Value=23486", ENDITEM, 
	...
	web_url("7052_17", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875505021", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t352.inf", 
	...
	web_url("7052_18", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875505022", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t357.inf", 
	...
	web_url("fetchAdvancedFilterInfo", 
		"URL=http://10.100.22.24:8181/signal/advancedFilter/fetchAdvancedFilterInfo?advancedFilter.id=23486", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t358.inf", 
	...
	web_url("7052_19", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875505023", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t367.inf", 
	...
	web_submit_data("delete", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=id", "Value=23486", ENDITEM, 
		LAST);

	web_add_cookie("dtSa=true%7CC%7C-1%7CYes%7C-%7C1580875626568%7C475504941_685%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2FsingleCaseAlert%2Fdetails%3FcallingScreen%3Dreview%26configId%3D495%26viewId%3D6199%26isCaseDetailView%3Dfalse%7CQualitative%20Alert%20Details%7C1580875508237%7C%7C; DOMAIN=10.100.22.24");
	...
	web_url("7052_20", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875628784", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t373.inf", 
	...
	web_url("7052_21", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875628785", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t377.inf", 
	...
	web_url("7052_22", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875628787", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t379.inf", 
	...
	web_url("7052_23", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875628788", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t383.inf", 
	...
	web_url("7052_24", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875628789", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t385.inf", 
	...
	web_add_cookie("dtSa=true%7CC%7C-1%7CSave%7C-%7C1580875707456%7C475628711_12%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2FsingleCaseAlert%2Fdetails%3FcallingScreen%3Dreview%26configId%3D495%26viewId%3D6199%26isCaseDetailView%3Dfalse%7CQualitative%20Alert%20Details%7C1580875632001%7C%7C; DOMAIN=10.100.22.24");
	...
	web_url("details_5", 
		"URL=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=23519", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199&isCaseDetailView=false", 
		"Snapshot=t388.inf", 
	...
	web_url("viewColumnInfo_6", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=23519", 
		"Snapshot=t390.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("7052_25", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875709888", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=23519", 
		"Snapshot=t392.inf", 
	...
	web_url("7052_26", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875709889", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=23519", 
		"Snapshot=t396.inf", 
	...
	web_add_cookie("dtSa=true%7CH%7C-1%7C%5BSELECT%5D%20to%20value%20%5BSystem%20View%5D%7C-%7C1580875746791%7C475709810_671%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2FsingleCaseAlert%2Fdetails%3FcallingScreen%3Dreview%26configId%3D495%26viewId%3D23519%7CQualitative%20Alert%20Details%7C1580875713099%7C%7C; DOMAIN=10.100.22.24");
	...
	web_url("details_6", 
		"URL=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=23519", 
		"Snapshot=t398.inf", 
	...
	web_url("viewColumnInfo_7", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199", 
		"Snapshot=t399.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("7052_27", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875748789", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199", 
		"Snapshot=t400.inf", 
	...
	web_url("7052_28", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875748790", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199", 
		"Snapshot=t404.inf", 
	...
	web_url("7052_29", 
		"URL=http://10.100.22.24:8181/signal/inboxLog/forUser/7052?_=1580875748791", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://10.100.22.24:8181/signal/singleCaseAlert/details?callingScreen=review&configId=495&viewId=6199", 
		"Snapshot=t405.inf", 
	...
	web_add_cookie("dtSa=true%7CC%7C-1%7CLogout%7C-%7C1580875782870%7C475748716_45%7Chttp%3A%2F%2F10.100.22.24%3A8181%2Fsignal%2FsingleCaseAlert%2Fdetails%3FcallingScreen%3Dreview%26configId%3D495%26viewId%3D6199%7CQualitative%20Alert%20Details%7C1580875751988%7C%7C; DOMAIN=10.100.22.24");
